...
$_lang['contentblocks.export_fields.confirm'] = "After clicking Yes below, we will prepare an XML export of all Fields in the currently selected category, or all if no category is chosen. This can be used to import the Fields later or in a different installation. Generating the XML may take a few seconds depending on the number of fields you have configured.";
...
$_lang['contentblocks.export_layouts.confirm'] = "After clicking Yes below, we will prepare an XML export of all Layouts in the currently selected category, or all if no category is chosen. This can be used to import the Layouts later or in a different installation. Generating the XML may take a few seconds depending on the number of layouts you have configured.";
...
$_lang['contentblocks.export_templates'] = 'Export';
$_lang['contentblocks.import_templates'] = 'Import';
...
$_lang['contentblocks.multiselect.wrapper_template.description'] = "Outer wrapper template for the multi-select values.";
...
$_lang['contentblocks.rebuild_content.exception'] = "[[+type]] exception triggered while parsing #[[+id]] ([[+pagetitle]]): [[+message]]";
...
$_lang['setting_contentblocks.image.create_directories'] = "Create dynamic directories";
$_lang['setting_contentblocks.image.create_directories_desc'] = "When enabled, ContentBlocks will automatically create dynamic directories (i.e. upload or browse paths contain placeholders) when rendering the canvas. This makes sure the MODX Media Browser can open to the correct directory, but may also cause empty directories to be created and we have seen some unexpected compatibility problems with Filesluggy.";
