...
class Redactor {
    ...
    */
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $this->version = new VersionObject(2, 1, 1, 'pl');
    ...
    */
    ...
    public function getGlobalOptions() {
        ...
        $options['lang'] = $this->getOption('redactor.lang', null, $this->getOption('manager_language'), true);
        ...
        if(!empty($removeAttr)) $options['removeAttr'] = $removeAttr;

        $allowedAttr = $this->getOption('redactor.allowedAttr', null,'');
        if(!empty($allowedAttr)) $options['allowedAttr'] = $allowedAttr;
...
HERE;
        ...
        if((bool)$this->getOption('redactor.plugin_eureka', null, true)) {
            ...
            $plugins[] = 'eureka';
            $this->modx->controller->addCSS($this->assetsUrl . 'lib/eureka/css/eureka.1.1.0.min.css');
            ...
            if((bool)$this->getOption('redactor.plugin_eureka_shivie9', null, true)) {
                $this->modx->controller->addJavascript($this->assetsUrl . 'lib/eureka/js/eureka.dom4.1.1.0.min.js');
                $this->modx->controller->addJavascript($this->assetsUrl . 'lib/eureka/js/eureka.no-flexbox.1.1.0.min.js');
            }
            $this->modx->controller->addJavascript($this->assetsUrl . 'lib/eureka/js/muckboot.eureka.1.1.0.min.js');
            $this->modx->controller->addJavascript($this->assetsUrl . 'lib/eureka/js/eureka.1.1.0.min.js');
        } else {
...
Ext.onReady(function() {
    ...
    public function initialize() {
        if (!$this->assetsLoaded) {
            ...
            $this->modx->controller->addCSS($this->config['assetsUrl'].'redactor-2.1.1.min.css');
            ...
            $this->modx->controller->addJavascript($this->config['assetsUrl'].'redactor-2.1.1.min.js');
