...
class Redactor {
    ...
    */
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $this->version = new VersionObject(2, 2, 1, 'pl');
...
Ext.onReady(function() {
    ...
    public function initialize() {
        if (!$this->assetsLoaded) {
            ...
            $this->modx->controller->addCSS($this->config['assetsUrl'].'redactor-2.2.1.min.css');
            ...
            $this->modx->controller->addJavascript($this->config['assetsUrl'].'redactor-2.2.1.min.js');
