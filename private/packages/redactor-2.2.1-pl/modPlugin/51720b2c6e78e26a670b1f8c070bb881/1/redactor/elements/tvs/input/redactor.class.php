...
HERE;
    ...
    protected function registerStuff() {
        $this->modx->controller->addCSS($this->redactor->config['assetsUrl'].'redactor-2.2.1.min.css');
        ...
        $this->modx->controller->addJavascript($this->redactor->config['assetsUrl'].'redactor-2.2.1.min.js');
$script = <<<HERE
<script>try {ace} catch(e) { document.write('<script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.1.9/ace.js"><\/script>') }</script>
HERE;
