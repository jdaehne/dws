...
$_lang['redactor.toolbarFixed'] = 'Fixed Toolbar';
$_lang['redactor.toolbarFixed.desc'] = 'Keep the toolbar in view by fixing it to the top of the screen when scrolling down.';
...
$_lang['setting_redactor.allow_data_uris'] = 'Allow data URIs';
$_lang['setting_redactor.allow_data_uris_desc'] = 'By default, with this option disabled, Redactor will filter out any inline images using data URIs as a security precaution. Data URIs can in some cases include scripts which poses a security risk. However if you have existing content that uses data URIs, it\'s less than ideal those get removed, so you can choose to allow those through this setting.';
